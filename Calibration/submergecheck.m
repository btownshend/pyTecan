...
function submergecheck(fit,angle,gmdl,maxvol)
%gfit=[5.17,29.25]
for startheight=[1:30]
  ...
  if maxerr>1.0
    fprintf('At end of aspirate of %5.1f ul from %5.1f ul, gemini will be %3.1f mm higher than it starts at (may aspirate air)\n', v1-maxv2, v1, maxerr);
  end
  if minerr<1
    fprintf('At end of aspirate of %5.1f ul from %5.1f ul, gemini will think it is %3.1f mm below bottom (will fail LD since Gemini will not allow this)\n', v1-minv2, v1, -minerr);
  end
end
end
