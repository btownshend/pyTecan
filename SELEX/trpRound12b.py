...
for iteration in range(2):
    ...
    pcr1=trp.runPCR(prefix=["A"],src=rt1[1],tgt=[],vol=50,srcdil=4)
    trp.diluteInPlace(tgt=pcr1,dil=3)
    sv1pcr=trp.saveSamps(src=pcr1,tgt=["R1"],vol=125,dil=1)
    
    # Round 2 (-theo, Ligate with B, keep cleaved B)
    ...
    lig2=trp.runLig(prefix="B",src=rt2+sv1rt,tgt=[],vol=[30,15,15,15,15,15,15,15,15,15],srcdil=3)
    ...
    pcr2=trp.runPCR(prefix="B",src="R1.T-.RT+.LB",tgt=[],vol=50,srcdil=4)
