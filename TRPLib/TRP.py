...
reagents.add("MTaqBar",well="D1",conc=2,ingredients={'Taq':0.5*1.5,'USER':0.5*3,'glycerol':0.5*4.5,'TAQ-ABE':51,'Water':44.5})
...
reagents.add("T3c",well='E3',conc=Concentration(3.333,1.0,'x'),extraVol=30) # BIAs less S-Reticuline
