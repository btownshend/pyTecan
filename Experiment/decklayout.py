...
TROUGH = PlateType("Trough",nx=1,ny=4,pierce=False,unusableVolume=100,maxVolume=100000,zmax=1367,gemDepth=0,gemArea=1232,gemShape='flat')
EPPLOWBIND=PlateType("EppLowBind",nx=12,ny=8,pierce=False,unusableVolume=15,maxVolume=200,
                zmax=1033,angle=17.5,r1=2.698,h1=9.31,v0=17.21,
...
RICBLOCK=PlateType("RICBlock",nx=6,ny=5,pierce=False,unusableVolume=20,maxVolume=1700,zmax=569,angle=17.5,r1=4.062,h1=17.75,v0=13.7,gemDepth=9.59,gemArea=43.03,gemShape='v-shaped')
QPCRPLATE=PlateType("qPCRPlate",nx=12,ny=8,pierce=False,unusableVolume=15,maxVolume=200,
                zmax=996,angle=17.5,r1=2.704,h1=10.89,v0=0.44,gemDepth=3.17,gemArea=14.33,gemShape='v-shaped')
EPPRACK = PlateType("EppRack", nx=1, ny=16, pierce=False, unusableVolume=30, maxVolume=1500, zmax=1337, angle=17.5,
                   h1=17.56, r1=4.42, v0=29.6, gemDepth=3.15, gemArea=31.4, gemShape='v-shaped')

############ Plate locations  #############
WATERLOC=PlateLocation(3,2)
BLEACHLOC=PlateLocation(3,3)
SSDDILLOC=PlateLocation(3,1)

REAGENTLOC=PlateLocation(18,1,slopex=-0.022,slopey=-0.038)
MAGLOC=PlateLocation(18,2)
SHAKERLOC=PlateLocation(9,0)
SAMPLELOC=PlateLocation(4,3)
DILUTIONLOC=PlateLocation(4,2)
QPCRLOC=PlateLocation(4,1)  # FIXME: defined in worklist.py
WASHLOC=PlateLocation(1,2)  # FIXME: defined in worklist.py
EPPLOC=PlateLocation(13,1)
TCPOS=PlateLocation(25,1)
HOTELPOS = PlateLocation(25, 0)
WASTELOC = PlateLocation(20, 3)

############ Physical Plates #############
WATERTROUGH=Plate(plateType=TROUGH, plateLocation=WATERLOC)
BLEACHTROUGH=Plate(plateType=TROUGH, plateLocation=WATERLOC)
WATERTROUGH=Plate(plateType=TROUGH, plateLocation=WATERLOC)

SAMPLEPLATE=Plate(plateType=EPPLOWBIND,plateLocation=SAMPLELOC)
SAMPLEPLATE.wells = SAMPLEPLATE.wells[1:-1]  # Skip A1 and H12 due to leakage
DILPLATE=Plate(plateType=EPPLOWBIND,plateLocation=DILUTIONLOC,backupPlate=SAMPLEPLATE)
EPPENDORFS=Plate(plateType=EPPRACK,plateLocation=EPPLOC)
